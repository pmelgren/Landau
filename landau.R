...
# read in the tables stored the data folder (after they have been prepared)
# by prepare_data.R)
...
scores = odds[scores,nomatch = 0]

scores = scores[,list(Season,Conference = conference,Date,Home,Away
